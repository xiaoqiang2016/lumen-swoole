...
return [
    ...
    */
    ...
    'connections' => [
        ...
        //     'strict' => env('DB_SINOCLICK_STRICT_MODE', false),
        ...
        'facetool' => [
            ...
            'port' => env('DB_SINOCLICK_PORT', 3306),
            'database' => env('DB_SINOCLICK_DATABASE', 'facetool'),
            'username' => env('DB_SINOCLICK_USERNAME', 'facetool_admin'),
            'password' => env('DB_SINOCLICK_PASSWORD', 'facetool_admin0418'),
            'unix_socket' => env('DB_SINOCLICK_SOCKET', ''),
            'charset' => env('DB_SINOCLICK_CHARSET', 'utf8mb4'),
            'collation' => env('DB_SINOCLICK_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => env('DB_SINOCLICK_PREFIX', ''),
        ...
        'facebook' => [
            'driver' => 'mysql',
            'host' => env('DB_FACEBOOK_HOST', '192.168.1.19'),
            'port' => env('DB_FACEBOOK_PORT', 3306),
            'database' => env('DB_FACEBOOK_DATABASE', 'facebook'),
            'username' => env('DB_FACEBOOK_USERNAME', 'fbdbuser'),
            'password' => env('DB_FACEBOOK_PASSWORD', '51715522'),
            ...
            'strict' => env('DB_FACEBOOK_STRICT_MODE', false),
        ...
        'msdw' => [
            'driver' => 'odbc',
            'dsn' => env('DB_MSDW_DSN', ''),
            'database' => env('DB_MSDW_DATABASE', 'DB_MSDW'),
            'host' => env('DB_MSDW_HOST', '127.0.0.1'),
            'username' => env('DB_MSDW_USERNAME', 'forge'),
            'password' => env('DB_MSDW_PASSWORD', ''),
            'port' => env('DB_MSDW_PORT', 5433),

//            'host' => env('DB_MSDW_HOST', '127.0.0.1'),
//            'port' => env('DB_MSDW_PORT', 5433),
//            'database' => env('DB_MSDW_DATABASE', 'forge'),
//            'username' => env('DB_MSDW_USERNAME', 'forge'),
//            'password' => env('DB_MSDW_PASSWORD', ''),
//            'unix_socket' => env('DB_FACEBOOK_SOCKET', ''),
//            'charset' => env('DB_FACEBOOK_CHARSET', 'utf8mb4'),
